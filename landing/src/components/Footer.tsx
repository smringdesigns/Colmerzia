...
=======
        <footer className="bg-[var(--color-night)] py-10 text-white">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-5 px-6 text-sm text-white/45 sm:flex-row sm:justify-between">
                <span className="font-display font-semibold text-white">Colmerzia</span>
>>>>>>> Stashed changes
                <div className="flex flex-wrap items-center justify-center gap-6">
                    ...
                    <a href={LOGIN_URL} className="transition hover:text-white">Iniciar sesión</a>
                    <a href={SIGNUP_URL} className="transition hover:text-white">Crear tienda</a>
                </div>
